class Building {
   ...
   static load(info, index) {
      ...
      switch (b.id) {
         case 237888253:
            b.img = new Image();
            b.img.src = "imgs/solenovo.png";
            b.imgScaler = 0.9;
            b.imgOffset = new Point(-50, -550);
            break;
         case 104710130:
            b.img = new Image();
            b.img.src = "imgs/arbonaut.png";
            break;
         case 40351427:
            b.img = new Image();
            b.img.src = "imgs/karelics.png";
            b.imgScaler = 1.3;
            break;
         case 87998750:
            b.img = new Image();
            b.img.src = "imgs/tiedepuisto.png";
            b.imgScaler = 2.3;
            b.imgOffset = new Point(200, 0);
            break;
         case 1132503307:
            b.img = new Image();
            b.img.src = "imgs/uef.png";
            b.imgScaler = 1.5;
            break;
         case 88110497:
            b.img = new Image();
            b.img.src = "imgs/karelia.png";
            b.imgScaler = 1.3;
            b.imgOffset = new Point(-140, 430);
            b.floorPlan = new Image();
            b.floorPlan.src = "imgs/floorplan.png";
            b.floorPlanScaler = 1;
